 ...
 * 默认时间格式:yyyy-MM-dd
 */
func MCDateManager_getDateFromString(_ dateString:String,dateFormat:String = "yyyy-MM-dd") -> Date {
 ...
 */
func MCDateManager_getTimeStrFromDate (_ date:Date,dateFormat:String = "yyyy-MM-dd") -> String {
 ...
 * 获取日期的年月日对象
 */
func MCDateManager_getDateComponents(date:Date) -> DateComponents {
 ...
 * 世界时间转为本地时间
 */
func MCDateManager_getLocalDateFromWorldDate(_ date:Date) -> Date {
 ...
 * one > two的情况teturn 1  ||||
 */
func MCDateManager_compareTwoDate(one:Date,two:Date) -> Int {
